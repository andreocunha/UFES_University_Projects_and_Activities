...
syms kpi
eq = 20*log10(kpi) + 11.3; % Trocar o valor de 8.83 por o valor que encontrar no grafico de ganho
kpi = double(solve(eq));
...
for i = [2 3 5 7 9 10 12 14 16 18 20 25 30 25 40]
...
for i = [1 1.1 1.2 1.3 1.4 1.5 1.6 1.7 2 2.5 3 4 5 6]
    result_kdd = i/wFgma;
...
n_pid_final = conv([kpi kii_array(15)], [kdd_array(5) 1]);
d_pid_final = [1 0];
